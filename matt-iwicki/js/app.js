...
function displayPics(){
  ...
  // Because the var for rando was changed to let, the variable rando is now only defined within the first while loop instead of globally.  Therefore, when rando is called outside of the while loop in a console.log, it is no longer defined due to the new scope.
  console.log(viewed)
